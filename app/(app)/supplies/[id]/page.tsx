...
export default function SupplyDetailPage() {
  ...
  function openOrder() {
    if (!supply) return;
    setOrderQty(Math.max(supply.min_quantity - supply.quantity, supply.min_quantity));
    setOrderNotes("");
    setSheet("order");
  }
  ...
  return (
    <>
      ...
      <div className="animate-in stagger-3" style={{ marginBottom: 16 }}>
        <p className="section-title">Used by ({supply.printers.length} printer{supply.printers.length !== 1 ? "s" : ""})</p>
